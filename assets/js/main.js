...
var _user$project$Main$encodeCard = _elm_lang$core$Json_Encode$string;
var _user$project$Main$bodyDecoder = _elm_lang$core$Json_Decode$field('data');
var _user$project$Main$combineResult = F3(
	function (fx, fe, res) {
		var _p0 = res;
		if (_p0.ctor === 'Ok') {
			return fx(_p0._0);
...
var _user$project$Main$cycle = function (items) {
	var _p1 = items;
	if (_p1.ctor === '[]') {
		return {ctor: '[]'};
	} else {
...
var _user$project$Main$uncycle = function (_p2) {
	return _elm_lang$core$List$reverse(
		_user$project$Main$cycle(
			_elm_lang$core$List$reverse(_p2)));
};
var _user$project$Main$expectNothing = _elm_lang$http$Http$expectStringResponse(
	function (_p3) {
		return _elm_lang$core$Result$Ok(
			{ctor: '_Tuple0'});
	});
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {newTask: a, draw: b, graveyard: c};
	});
var _user$project$Main$Card = F3(
	function (a, b, c) {
		return {id: a, sides: b, ctype: c};
	});
var _user$project$Main$Task = {ctor: 'Task'};
var _user$project$Main$Fact = {ctor: 'Fact'};
var _user$project$Main$toCardType = function (ct) {
	var _p4 = ct;
	switch (_p4) {
		case 'FACT':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Main$Fact);
		case 'TASK':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Main$Task);
		default:
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], _p4, ' is not a valid card type.'));
	}
};
var _user$project$Main$cardDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	...
	A2(
		_elm_lang$core$Json_Decode$field,
		'card_type',
		A2(_elm_lang$core$Json_Decode$andThen, _user$project$Main$toCardType, _elm_lang$core$Json_Decode$string)));
var _user$project$Main$cardsDecoder = _elm_lang$core$Json_Decode$list(_user$project$Main$cardDecoder);
var _user$project$Main$fetchCards = A2(
	_elm_lang$http$Http$get,
	'/api/cards',
	_user$project$Main$bodyDecoder(_user$project$Main$cardsDecoder));
var _user$project$Main$EditNewTaskPriority = function (a) {
	return {ctor: 'EditNewTaskPriority', _0: a};
};
		...
		{ctor: '[]'},
		{
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(_p8.body),
								_1: {
									ctor: '::',
			...
			_1: {
				...
				_0: function () {
					var _p7 = _p6.draw;
					if (_p7.ctor === '[]') {
						return _elm_lang$html$Html$text('no cards');
					} else {
...
var _user$project$Main$FlopCard = {ctor: 'FlopCard'};
var _user$project$Main$FlipCard = {ctor: 'FlipCard'};
var _user$project$Main$PrevCard = {ctor: 'PrevCard'};
var _user$project$Main$NextCard = {ctor: 'NextCard'};
var _user$project$Main$FetchCards = {ctor: 'FetchCards'};
var _user$project$Main$LoadCards = function (a) {
	return {ctor: 'LoadCards', _0: a};
};
...
var _user$project$Main$Log = function (a) {
	return {ctor: 'Log', _0: a};
};
var _user$project$Main$update = F2(
	function (msg, _p9) {
		var _p10 = _p9;
		var _p26 = _p10.newTask;
		var _p25 = _p10;
		var _p24 = _p10.graveyard;
		var _p23 = _p10.draw;
		var _p11 = msg;
		switch (_p11.ctor) {
			case 'NoOp':
				return A2(
					...
					{ctor: '[]'});
			case 'Log':
				var _p12 = A2(_elm_lang$core$Debug$log, 'LOG', _p11._0);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_p25,
					{ctor: '[]'});
			...
			case 'LoadCards':
				if (_p11._0.ctor === 'Ok') {
					...
					var _p13 = A2(_elm_lang$core$Debug$log, 'ERROR', _p11._0._0);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_p25,
						{ctor: '[]'});
				...
				if (_p14.ctor === '[]') {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								draw: _p14._1,
								graveyard: {ctor: '::', _0: _p14._0, _1: _p24}
							}),
						{ctor: '[]'});
				}
			case 'PrevCard':
							...
							_p25,
							{
								draw: {
									...
									_0: _elm_lang$core$Native_Utils.update(
										_p17,
										{
											sides: _user$project$Main$cycle(_p17.sides)
										}),
									_1: _p16._1
								}
							}),
							...
							_p25,
							{
								draw: {
									...
									_0: _elm_lang$core$Native_Utils.update(
										_p19,
										{
											sides: _user$project$Main$uncycle(_p19.sides)
										}),
									_1: _p18._1
								}
							}),
								...
								_elm_lang$http$Http$request(
									{
										...
										body: _elm_lang$http$Http$jsonBody(
											_elm_lang$core$Json_Encode$int(_p11._0)),
													...
													_elm_lang$core$Json_Encode$object(
														{
															...
															_0: A2(
																_user$project$Main_ops['=>'],
																'body',
																_elm_lang$core$Json_Encode$string(_p26.body)),
															_1: {
																ctor: '::',
																_0: A2(
																	_user$project$Main_ops['=>'],
																	'priority',
																	_elm_lang$core$Json_Encode$float(_p26.priority)),
																_1: {ctor: '[]'}
															}
														})),
												_1: {ctor: '[]'}
					...
					_elm_lang$core$Native_Utils.update(
						_p25,
						{
							newTask: _elm_lang$core$Native_Utils.update(
								_p26,
								{
									priority: A3(_elm_lang$core$Basics$clamp, 0, 1, _p11._0)
								})
						}),
					{ctor: '[]'});
		}
...
var _user$project$Main$subscriptions = function (_p27) {
	var _p28 = _p27;
	var _p30 = _p28.newTask;
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: function () {
				var handleKeypress = function (keyCode) {
					var _p29 = _elm_lang$core$Char$fromCode(keyCode);
					switch (_p29.valueOf()) {
						case '\r':
							return _user$project$Main$SubmitNewTask;
						case 'J':
							return _user$project$Main$EditNewTaskPriority(_p30.priority - 0.1);
						case 'K':
							return _user$project$Main$EditNewTaskPriority(_p30.priority + 0.1);
						case 'r':
							return _user$project$Main$FetchCards;
						case 'l':
							return _user$project$Main$NextCard;
						case 'h':
							return _user$project$Main$PrevCard;
						case 'j':
							return _user$project$Main$FlopCard;
						case 'k':
							return _user$project$Main$FlipCard;
						case ' ':
							return _user$project$Main$FlipCard;
						case '\'':
							return _user$project$Main$RateCard(1);
						case ',':
							return _user$project$Main$RateCard(2);
						case '.':
							return _user$project$Main$RateCard(3);
						case 'p':
							return _user$project$Main$RateCard(4);
						default:
							return _user$project$Main$NoOp;
					}
				};
				return _elm_lang$keyboard$Keyboard$downs(handleKeypress);
			}(),
			_1: {ctor: '[]'}
		});
};
