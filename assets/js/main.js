...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {newTask: a, draw: b, graveyard: c, isCardFocused: d};
	});
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$FocusCard),
						_1: {
							ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$FocusNewTask),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									_p12 ? {
					...
					if (_p41 === false) {
						...
						switch (_p43.valueOf()) {
							...
							case '\'':
								return _user$project$Main$NextCard;
							case '0':
								return _user$project$Main$EditNewTaskPriority(0.0);
							case '1':
								return _user$project$Main$EditNewTaskPriority(0.1);
							case '2':
								return _user$project$Main$EditNewTaskPriority(0.2);
							case '3':
								return _user$project$Main$EditNewTaskPriority(0.3);
							case '4':
								return _user$project$Main$EditNewTaskPriority(0.4);
							case '5':
								return _user$project$Main$EditNewTaskPriority(0.5);
							case '6':
								return _user$project$Main$EditNewTaskPriority(0.6);
							case '7':
								return _user$project$Main$EditNewTaskPriority(0.7);
							case '8':
								return _user$project$Main$EditNewTaskPriority(0.8);
							case '9':
								return _user$project$Main$EditNewTaskPriority(0.9);
							case 'B':
								return _user$project$Main$RateCard(0.0);
							case 'M':
								return _user$project$Main$RateCard(0.25);
							case 'W':
								return _user$project$Main$RateCard(0.5);
							case 'V':
								return _user$project$Main$RateCard(0.75);
							case 'Z':
