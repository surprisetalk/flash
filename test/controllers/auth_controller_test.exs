defmodule Flash.AuthControllerTest do
  use Flash.ConnCase
              ...
              extra: %{
                raw_info: %{
                  ...
                  user: %{
                    "id" => 15_790_393,
                    "profile_image_url" =>
                      "http://pbs.twimg.com/profile_images/414776155590623232/HuQHFxhw_normal.jpeg",
                    "location" => "Chicago",
                    "name" => "Alex Koppel",
                    "url" => "https://t.co/BEpi01CxV8",
                    "description" =>
                      "ex-expat, book reader, principal ☃ engineer at @esparklearning, part of @chicagoawesome. Jew. Gay.",
                    "profile_image_url_https" =>
                      "https://pbs.twimg.com/profile_images/414776155590623232/HuQHFxhw_normal.jpeg",
                    "screen_name" => "arsduo"
                  }
                }
              },
